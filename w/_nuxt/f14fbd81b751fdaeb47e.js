(window.webpackJsonp = window.webpackJsonp || []).push([
	[0], {
		...
		237: function (t, e, n) {
			(e = n(39)(!1)).push([t.i, ".loader{position:fixed;z-index:9001}.bgColor,.loader{top:0;left:0;width:100%;height:100%}.bgColor{background-color:#000}.bgColor,.words{position:absolute}.words{top:0;left:0;right:0;bottom:0}.word{position:absolute;color:#fff;background-color:#000;display:block;font-size:5vw;line-height:1em;padding:.8vw;white-space:nowrap}@media (max-width:1024px){.word{font-size:7.5vw;padding:1.4vw}}@media (max-width:767px){.word{font-size:35px;padding:7px}}", ""]), t.exports = e
		},
		238: function (t, e, n) {
			"use strict";
			var o = n(91);
		...
		25: function (t, e, n) {
			...
			var C = {
				...
				B = {
					...
					data: function () {
						return {
							wordsRaw: ["Welcome —", "Out of Chaos Emerges Order —", "Simplicity —", "Structure —", "Order —", "Framework —", "Organization —", "Strategy —", "Organization —", "Art Direction —", "Interactive —", "Design —", "Prototype —", "Pranay 20’ —", "Culture —", "Discovery —", "Branding —", "Lifestyle Marketing —", "Product Design —"],
							words: null,
							done: !1
						}
					},
			...
			var F, Y = {
				...
				K = (n(238), Object(S.a)(Y, (function () {
					...
					return e("div", {
						...
						staticClass: "hr-hl"
					}, [this._v("Out Of Chaos")]), this._v(" "), e("span", {
						staticClass: "hr-sl"
					}, [this._v("Emerges Order")])])
				}], !1, null, null, null).exports),
				V = {
					name: "Footer",
					components: {},
				...
				X = (n(240), Object(S.a)(V, (function () {
					...
					return n("section", {
						...
						staticClass: "foo-name"
					}, ), t._v(" "), t._m(0), t._v(" "), t._m(1), t._v(" "), n("div", {
						staticClass: "foo-place"
					}, [n("span", {
						staticClass: "foo-hl"
					}, [t._v(t._s(this.loc && this.loc.coords))]), t._v(" "), n("span", {
						staticClass: "foo-sl"
						...
						staticClass: "foo-navline"
					}, )])])])])])
				}), [function () {
					var t = this.$createElement,
						e = this._self._c || t;
					return e("div", {
						staticClass: "foo-legal"
					}, [e("span", {
						staticClass: "foo-sl"
					}, [this._v("")])])
				}, function () {
					var t = this.$createElement,
						e = this._self._c || t;
					return e("div", {
						staticClass: "foo-coded"
					}, [e("span", {
						staticClass: "foo-hl"
					}, ), this._v(" "), e("span", {
						staticClass: "foo-sl"
					}, [e("a", {
						staticClass: "foo-link",
						attrs: {
			...
			n.n(lt).a.load({
				custom: {
					families: ["GtSectra_Regular-Italic", "GtSectra_Medium", "Untitled-Sans_Light", "Untitled-Sans_Medium", "Untitled-Sans_Regular"],
